...
class MemberRepositoryTest {
    ...
    public void returnType() {
        ...
        System.out.println(memberRepository.findMemberByUsername("BBB"));
    ...
    public void paging() throws Exception {
        ...
        System.out.println("totalEle = " + totalElements);
        ...
        //when
        Slice<Member> slice = memberRepository.findMembersByAge(age, pageRequest);
        //then
        List<Member> content2 = slice.getContent();
        content2.stream().forEach(System.out::println);
